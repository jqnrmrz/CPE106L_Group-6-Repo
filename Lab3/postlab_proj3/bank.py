...
class Bank:
    ...
    def __str__(self):
        # Sort the accounts by name before generating the string
        self.sort_accounts_by_name()

        account_strings = [str(account) for account in self.accounts]
        return "\n".join(account_strings)
